...
gctx.strokeStyle= '#e4dfd7'; //Color del marco de reloj
gctx.lineWidth=20;
gctx.shadowColor = '#1b1b1b';
...
gctx.beginPath()
gctx.strokeStyle= '#424242';///#464623'; color lineas del reloj
if((j % (5*angle_jump))==0){
...
gctx.font = '32px serif'; //tamaño de los numeros
...
///////////Minute Needle//////////
gctx.beginPath()
gctx.strokeStyle= '#242323'; // border color of the minute needle 
...
gctx.fillStyle = '#242323'; // fill colour of the minute needle
gctx.fill();
...
///////////hour Needle//////////
gctx.beginPath()
gctx.strokeStyle= '#000'; // border color of the hour needle 
...
gctx.fillStyle = '#000'; // fill colour of the hour  needle
gctx.fill();
gctx.stroke(); // draw the hour needle 
//////////////////////////////////
//////////Second Needle///////////
gctx.beginPath()
gctx.strokeStyle= '#cf0000'; // border color of the second needle 
...
gctx.fillStyle = '#cf0000'; // fill colour of the second needle
gctx.fill();
...
gctx.fillStyle = '#000000'; //color de los numeros
gctx.fill();
gctx.stroke();
my_function2();
}
