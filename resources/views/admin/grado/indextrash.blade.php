                                ...
                                <tr>
                                    ...
                                    <td width="270px">
                                        <div class="d-flex" style="gap: 10px">
                                            <form action="{{ route('admin.grado.restaurargrado', $grado) }}"
                                                method="POST">
                                            ...
                                            <form action="{{ route('admin.grado.destroy', $grado) }}"
