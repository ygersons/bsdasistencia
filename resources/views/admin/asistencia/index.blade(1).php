...
<body onload="setFocusToTextBox()">
    <header>
        <nav style="background-color: #B3212E;min-height: 75px; margin-bottom: 10px;">
            <div class="" style="padding-top: 15px">
                ...
                <h2 style="color: white; margin-left: 135px;font-size:40px;text-align: center">Gestión de Asistencia</h2>
        
            </div>
        </nav>
    </header>
    <div class="container" style="width: 560px; height: 500px;">
        <div class="container-clock">
            @livewire('admin.asistencia-reloj-index')
            <form action="/gEntrada" method="get" class="form-control f-asistencia">
                @csrf
                <div class="container-clock" style="font-size:32px;">
                    <label class="form-label fw-bolder fs-5">Registrar Entrada</label><br>
                    <input type="int" maxlength="8" id="idestudiante" name="estudiante" class="form-control ">
                </div>

            </form>
            <div style="margin: 30px 0px"></div>
            <div class="card" style="height: 90px; width:auto; font-size:32px;">
